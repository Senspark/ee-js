...
// const materialClass = cc.ENGINE_VERSION >= '2.1.3' ? (cc as any).Material : cc.renderer.renderEngine.Material;
// const gfx = cc.ENGINE_VERSION >= '2.1.3' ? (cc as any).gfx : cc.renderer.renderEngine.gfx;
